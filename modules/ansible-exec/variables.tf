...
SAP_DEPLOYMENT = "sap-abap-ase-syb-standard"
SCHEMATICS_TIMEOUT = 40         #(Max 55 Minutes). It is multiplied by 5 on Schematics deployments and it is relying on the ansible-logs number.
